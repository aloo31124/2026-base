      ...
      <section className="auth-visual">
        ...
        <div>
          ...
          <div className="workflow-preview">
            <span className="workflow-node">確認信箱</span>
            <i className="workflow-line" />
            <span className="workflow-node">核對驗證碼</span>
            <i className="workflow-line" />
        ...
        <div className="auth-box">
          ...
          {step === 1 && (
            <form className="auth-form" onSubmit={sendCode}>
              ...
              <button
                data-testid="registration-send-code"
          ...
          <div className="auth-status" aria-live="polite">
            {message && (
              <p className="success" data-testid="registration-message">
                {message}
              </p>
            )}
            {error && (
