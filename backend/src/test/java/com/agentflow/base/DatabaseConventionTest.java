...
class DatabaseConventionTest {
    ...
    @Test
    void companySupervisorChineseTextUsesNationalizedColumns() throws Exception {
        assertThat(Company.class.getDeclaredField("name").getAnnotation(Nationalized.class)).isNotNull();
        assertThat(Company.class.getDeclaredField("description").getAnnotation(Nationalized.class)).isNotNull();
        assertThat(SupervisorProfile.class.getDeclaredField("title").getAnnotation(Nationalized.class)).isNotNull();
    }
}
